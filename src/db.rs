    ...
    // Create the table if it doesn't exist
    {
        ...
        conn.execute(
            "CREATE TABLE IF NOT EXISTS parcel (
                ...
                flood_risks TEXT,
                oby_count DOUBLE,
                sale_price DOUBLE,           -- Added for Scenario 13
                developer_id TEXT,           -- Added for Scenario 14
                building_permits DOUBLE       -- Added for Scenario 14
            )",
            [],
        )?;
    }
...
//////////////////////////
/// 15 New Detection Functions
//////////////////////////

/// Scenario 1: Inflated Property Appraisals for Bribery Schemes
...
/// Scenario 3: Rapid Flipping of Parcels to Evade Tax Scrutiny
...
/// Scenario 4: Discrepancies in Legal Descriptions for Land Grab Schemes
...
/// Scenario 5: Undervalued Property Assessments Linked to Favoritism
...
/// Scenario 6: Suspicious Zoning Changes Triggering Land Use Corruption
...
/// Scenario 7: Irregularities in Building Permits and Structures
...
/// Scenario 8: Multiple Properties Owned by Single Individuals in High-Risk Areas
...
/// Scenario 9: Unusual Patterns in Business Licenses Linked to Property Ownership
...
/// Scenario 10: Inconsistent Owner Addresses Indicating Concealed Identities
...
/// Scenario 11: Disproportionate Property Values Compared to Physical Attributes
...
/// Scenario 12: Frequent Changes in Property Classification for Tax Evasion
...
/// Scenario 13: Patterns of Sale in High Flood Risk Areas Suggesting Insurance Fraud
...
/// Scenario 14: Disproportionate Allocation of Building Permits to Specific Developers
...
/// Scenario 15: Unexplained Acquisition of Multiple Units in Single Parcel
